...
class TransactionViewModel : ViewModel() {
    ...
    fun getTransactions(): Map<String, List<Dummy>> =
        _transactionstate.value.groupBy { it.Date }.toMutableMap()
    ...
    fun getRegularTransaction(): List<Dummy> = _transactionstate.value.toList().distinctBy {
        it.ReceipientName
    }
